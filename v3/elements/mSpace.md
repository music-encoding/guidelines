               ...
               <div class="indent1">
                  ...
                  <div class="indent2">
                     <span data-indentation="2" class="element">&lt;memberOf 
                        <span class="attribute">key=</span>
                        <span class="attributevalue">"
                           <a class="link_odd" href="/att.mSpace.log">att.mSpace.log</a>"
                        </span>/&gt;
                     </span>
                  </div>
                  ...
                  <div class="indent2">
                     <span data-indentation="2" class="element">&lt;memberOf 
                        <span class="attribute">key=</span>
                        <span class="attributevalue">"
                           <a class="link_odd" href="/att.mSpace.vis">att.mSpace.vis</a>"
                        </span>/&gt;
                     </span>
                  </div>
                  ...
                  <div class="indent2">
                     <span data-indentation="2" class="element">&lt;memberOf 
                        <span class="attribute">key=</span>
                        <span class="attributevalue">"
                           <a class="link_odd" href="/att.mSpace.ges">att.mSpace.ges</a>"
                        </span>/&gt;
                     </span>
                  </div>
                  ...
                  <div class="indent2">
                     <span data-indentation="2" class="element">&lt;memberOf 
                        <span class="attribute">key=</span>
                        <span class="attributevalue">"
                           <a class="link_odd" href="/att.mSpace.anl">att.mSpace.anl</a>"
                        </span>/&gt;
                     </span>
                  </div>
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>The automated numbering of consecutive measures of space may be controlled via the
               ...
               <a class="link_odd_elementSpec" href="/{{ page.version }}/scoreDef">scoreDef</a> or 
               <a class="link_odd_elementSpec" href="/{{ page.version }}/staffDef">staffDef</a> elements.
            </p>
         </td>
      </tr>
   </table>
