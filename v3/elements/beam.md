      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>For beams that cross the bar line, use the <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/beamSpan.html">beamSpan</a> element.
               ...
               beams,
               may be indicated for an entire score, part or section by using the <span class="att">beam.group</span>
               and <span class="att">beam.rests</span> attributes on these elements.
            </p>
         </td>
      </tr>
      <tr>
