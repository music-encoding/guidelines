         ...
         <td class="wovenodd-col2">
            <table class="table table-striped">
               ...
               <tbody>
                  ...
                  <tr>
                     <td>
                        <div class="attributeDef"><span class="attribute"><strong>@type</strong></span><span class="attributeUsage">(required)</span><span class="attributeDesc">Characterizes the property name.</span>
                           Allowed values are:
                           "<span style="font-weight: 500;">unicode</span>" <i>(A registered Unicode normative or informative property name.)</i>,  "<span style="font-weight: 500;">local</span>" <i>(A locally defined name.)</i><span class="attributeClasses"><a class="link_odd" href="{{ site.baseurl }}/{{ page.version }}/attribute-classes/propname.html">propName</a></span></div>
                     </td>
                  </tr>
                  <tr>
                     <td>
         ...
         <td class="wovenodd-col2">
            <div class="parent">
               <div class="specChildren">
                  <div class="specChild"><span class="specChildModule">MEI.usersymbols</span><span class="specChildElements"><a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/symprop.html">symProp</a></span></div>
               </div>
            </div>
         </td>
      </tr>
