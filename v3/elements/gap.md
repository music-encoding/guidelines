      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>When material is omitted because it is illegible or inaudible, 
               <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/unclear.html">unclear</a> should be used instead. Similarly, use 
               <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/damage.html">damage</a> if the
               omission is due to damage and 
               <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/del.html">del</a> if the omission is because the
               ...
               <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/gap.html">gap</a> tag. The 
