      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>Examples of corporate entities include names of associations, institutions, business
               ...
               <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/corpName.html">corpName</a> sub-elements. The name of the list from which a controlled value is taken
