         ...
         <td class="wovenodd-col2">
            ...
            <div class="attributeDef">
               ...
               <span class="attributeDesc">Used to indicate the format of a list. In a "simple" list, 
                  ...
                  the
                  start of each 
                  <a class="link_odd_elementSpec" href="/{{ page.version }}/item">item</a>. In an "ordered" list, the sequence of the
                  items is important, and each 
                  <a class="link_odd_elementSpec" href="/{{ page.version }}/li">li</a> is lettered or numbered. Style
               ...
               <span class="attributeClasses">
                  <a class="link_odd" href="/{{ page.version }}/list">list</a>
               </span>
            </div>
            <div class="attributeDef">
