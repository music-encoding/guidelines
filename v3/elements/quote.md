               ...
               <div class="indent1">
                  ...
                  <div class="indent2">
                     <span data-indentation="2" class="element">&lt;memberOf 
                        <span class="attribute">key=</span>
                        <span class="attributevalue">"
                           <a class="link_odd" href="/model.quoteLike">model.quoteLike</a>"
                        </span>/&gt;
                     </span>
                  </div>
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>The source for the quote may be included in the optional 
               <a class="link_odd_elementSpec" href="/{{ page.version }}/bibl">bibl</a>
               sub-element. Use 
               <a class="link_odd_elementSpec" href="/{{ page.version }}/rend">rend</a> for words that are enclosed in quotation marks
