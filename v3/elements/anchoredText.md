      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>This element may be used where semantic markup of the text is neither possible nor
               ...
               coordinate terms using the <span class="att">x</span> and <span class="att">y</span> attributes or relative to the
               location of another element using the <span class="att">startid</span> attribute. The attributes in the
