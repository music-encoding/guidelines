      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>The starting point of the curve may be identified in absolute output coordinate terms
               using the <span class="att">x</span> and <span class="att">y</span> attributes or relative to the location of another
               element using the <span class="att">startid</span> attribute. The attributes in the att.visualoffset
               ...
               point
               of the curve may be recorded using either the <span class="att">x2</span> and <span class="att">y2</span> coordinates
               or in relation to the location of another element using the <span class="att">endid</span> attribute.
               Attributes in the att.visualoffset2 class maybe used to record the offsets of the
               ending
               point. The <span class="att">bulge</span> attribute or, alternatively, the <span class="att">bezier</span> attribute,
               describe the shape of the curve and the <span class="att">lform</span> and <span class="att">lwidth</span> attributes
