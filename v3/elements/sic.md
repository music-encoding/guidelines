      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>A correction for the apparent error may be given in an accompanying child or sibling
               <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/corr.html">corr</a> element.This element is modelled on an element in the Text Encoding Initiative (TEI)
               standard.
            </p>
         </td>
      </tr>
