      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>The <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/beam.html">beam</a> sub-element is allowed so that custom beaming may be
               ...
               decimal
               values may be used in the <span class="att">dur.ges</span> attribute. For example, the
               <span class="att">dur.ges</span> attribute would take the value "2.5" if the <span class="att">midi.div</span>
               attribute's value was "1". The <span class="att">num</span> and <span class="att">numbase</span> attributes may be
