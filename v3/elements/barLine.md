      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            ...
            <div class="attributeDef">
               ...
               <span class="attributeClasses">
                  <a class="link_odd" href="/v3/att.barLine.log">att.barLine.log</a>
               </span>
            </div>
            <div class="attributeDef">
               ...
               <div class="indent1">
                  ...
                  <div class="indent2">
                     <span data-indentation="2" class="element">&lt;memberOf 
                        <span class="attribute">key=</span>
                        <span class="attributevalue">"
                           <a class="link_odd" href="/att.barLine.log">att.barLine.log</a>"
                        </span>/&gt;
                     </span>
                  </div>
                  ...
                  <div class="indent2">
                     <span data-indentation="2" class="element">&lt;memberOf 
                        <span class="attribute">key=</span>
                        <span class="attributevalue">"
                           <a class="link_odd" href="/att.barLine.vis">att.barLine.vis</a>"
                        </span>/&gt;
                     </span>
                  </div>
                  ...
                  <div class="indent2">
                     <span data-indentation="2" class="element">&lt;memberOf 
                        <span class="attribute">key=</span>
                        <span class="attributevalue">"
                           <a class="link_odd" href="/att.barLine.ges">att.barLine.ges</a>"
                        </span>/&gt;
                     </span>
                  </div>
                  ...
                  <div class="indent2">
                     <span data-indentation="2" class="element">&lt;memberOf 
                        <span class="attribute">key=</span>
                        <span class="attributevalue">"
                           <a class="link_odd" href="/att.barLine.anl">att.barLine.anl</a>"
                        </span>/&gt;
                     </span>
                  </div>
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>This element is provided for repertoires, such as mensural notation, that lack measures.
               Because the 
               <a class="link_odd_elementSpec" href="/v3/barLine">barLine</a> element's attributes, from which the logical and
               ...
               <a class="link_odd_elementSpec" href="/v3/measure">measure</a> elements
               in CMN.
            </p>
         </td>
      </tr>
