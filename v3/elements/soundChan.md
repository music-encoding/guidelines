      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            ...
            <div class="attributeDef">
               ...
               <span class="attributeClasses">
                  <a class="link_odd" href="/v3/soundChan">soundChan</a>
               </span>
            </div>
            <div class="attributeDef">
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>The number of apparent playback channels can differ from the number of physical channels
               ...
               <a class="link_odd_elementSpec" href="/v3/trackConfig">trackConfig</a> element should capture the existence of two physical
