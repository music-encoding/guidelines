         ...
         <td class="wovenodd-col2">
            <div class="attributeDef">
               ...
               <span class="attributeClasses">
                  <a class="link_odd" href="/{{ page.version }}/rend">rend</a>
               </span>
            </div>
            <div class="attributeDef">
            ...
            <div class="attributeDef">
               ...
               Value conforms to 
               <a class="link_odd_classSpec" href="/{{ page.version }}/data.DEGREES">data.DEGREES</a>.
               ...
               <div class="indent1">
                  ...
                  <div class="indent2">
                     <span data-indentation="2" class="element">&lt;memberOf 
                        <span class="attribute">key=</span>
                        <span class="attributevalue">"
                           <a class="link_odd" href="/att.horizontalalign">att.horizontalalign</a>"
                        </span>/&gt;
                     </span>
                  </div>
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>When an entire element should be rendered in a special way, a style sheet function
               ...
               <a class="link_odd_elementSpec" href="/{{ page.version }}/rend">rend</a> element.
            </p>
         </td>
      </tr>
   </table>
