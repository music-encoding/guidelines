         ...
         <td class="wovenodd-col2">
            <table class="table table-striped">
               ...
               <tbody>
                  ...
                  <tr>
                     <td>
                        <div class="attributeDef"><span class="attribute"><strong>@valign</strong></span><span class="attributeUsage">(optional)</span><span class="attributeDesc">Specifies the vertical position of the element content relative to the surrounding
                              text.</span>
                           Allowed values are:
                           "<span style="font-weight: 500;">top</span>" <i>(Aligns the top of the content with the top of the surrounding text.)</i>,  "<span style="font-weight: 500;">middle</span>" <i>(Aligns the middle of the content with the middle of the surrounding text.)</i>,  "<span style="font-weight: 500;">bottom</span>" <i>(Aligns the bottom of the content with the bottom of the surrounding text.)</i>,  "<span style="font-weight: 500;">baseline</span>" <i>(Aligns the baseline of the content with the baseline of the surrounding
                              text.)</i><span class="attributeClasses"><a class="link_odd" href="{{ site.baseurl }}/{{ page.version }}/attribute-classes/rend.html">rend</a></span></div>
                     </td>
                  </tr>
                  <tr>
                     <td>
