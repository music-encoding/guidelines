      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>This element may be used for instantaneous or continuous <em class="mentioned">textual</em> dynamics,
               e.g. 'p', 'mf', or 'cresc. poco a poco'. The <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/hairpin.html">hairpin</a> element should
               be used for <em class="mentioned">graphical</em>, i.e., crescendo and diminuendo, dynamic markings. The
