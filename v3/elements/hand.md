...
<div class="elementSpec">
   ...
   <table class="wovenodd">
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>The <span class="att">initial</span> attribute indicates whether this is the first or main scribe of
               the document. The <span class="att">medium</span> attribute describes the writing medium, e.g.,
               'pencil', or the tint or type of ink, e.g. 'brown'. The <span class="att">resp</span> attribute contains
               ...
               the
               content of the <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/hand.html">hand</a> element. This element is modelled on an element in the Text Encoding Initiative (TEI)
               standard.
            </p>
         </td>
      </tr>
