...
<div class="elementSpec">
   ...
   <table class="wovenodd">
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            ...
            <div class="attributeDef">
               ...
               Value conforms to 
               <a class="link_odd_classSpec" href="/v3/data.UNEUMEFORM">data.UNEUMEFORM</a>.
               
               <span class="attributeClasses">
                  <a class="link_odd" href="/v3/att.uneume.log">att.uneume.log</a>
               </span>
            </div>
            <div class="attributeDef">
            ...
            <div class="attributeDef">
               ...
               Value conforms to 
               <a class="link_odd_classSpec" href="/v3/data.UNEUMENAME">data.UNEUMENAME</a>.
               ...
               <div class="indent1">
                  ...
                  <div class="indent2">
                     <span data-indentation="2" class="element">&lt;memberOf 
                        <span class="attribute">key=</span>
                        <span class="attributevalue">"
                           <a class="link_odd" href="/att.uneume.log">att.uneume.log</a>"
                        </span>/&gt;
                     </span>
                  </div>
                  ...
                  <div class="indent2">
                     <span data-indentation="2" class="element">&lt;memberOf 
                        <span class="attribute">key=</span>
                        <span class="attributevalue">"
                           <a class="link_odd" href="/att.uneume.vis">att.uneume.vis</a>"
                        </span>/&gt;
                     </span>
                  </div>
                  ...
                  <div class="indent2">
                     <span data-indentation="2" class="element">&lt;memberOf 
                        <span class="attribute">key=</span>
                        <span class="attributevalue">"
                           <a class="link_odd" href="/att.uneume.ges">att.uneume.ges</a>"
                        </span>/&gt;
                     </span>
                  </div>
                  ...
                  <div class="indent2">
                     <span data-indentation="2" class="element">&lt;memberOf 
                        <span class="attribute">key=</span>
                        <span class="attributevalue">"
                           <a class="link_odd" href="/att.uneume.anl">att.uneume.anl</a>"
                        </span>/&gt;
                     </span>
                  </div>
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>While 
               <a class="link_odd_elementSpec" href="/v3/ineume">ineume</a> is allowed as a sub-element of 
               <a class="link_odd_elementSpec" href="/v3/uneume">uneume</a> as part of the model.eventLike.neume class, it is unlikely that an
