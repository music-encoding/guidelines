   ...
   <table class="wovenodd">
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <div class="parent">
               <div>
                  <a class="link_odd_elementSpec" href="/{{ page.version }}/annot">annot</a> (direct member of att.annot.log)
               </div>
            </div>
         </td>
      </tr>
         ...
         <td class="wovenodd-col2">
            <div xml:space="preserve" class="pre">
               <div class="indent1">
                  ...
                  <div class="indent2">
                     <span data-indentation="2" class="comment">&lt;!-- Some attributes defined in att.controlevent (att.timestamp.musical, att.timestamp.performed,
