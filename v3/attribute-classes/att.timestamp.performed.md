         ...
         <td class="wovenodd-col2">
            <div class="parent">
               ...
               <div>
                  ...
                  <span> (via 
                     <a class="link_odd_classSpec" href="{{ site.baseurl }}/{{ page.version }}/attribute-classes/att.measure.ges.html">att.measure.ges</a>)
                  </span>
               </div>
               <div>
                  ...
                  <div class="indent2 indent">
                     ...
                     <div class="indent3 indent">
                        <span data-indentation="3" class="element">&lt;rng:ref
                           ...
                           <span class="attribute">name=
                              <span class="attributevalue">"
                                 <a class="link_odd" href="{{ site.baseurl }}/{{ page.version }}/data-types/data.ISOTIME.html">data.ISOTIME</a>"
                              </span>
                           </span>
                           /&gt;
                        </span>
