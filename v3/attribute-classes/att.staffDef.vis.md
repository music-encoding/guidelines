   ...
   <table class="wovenodd">
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <div class="parent">
               <div>
                  <a class="link_odd_elementSpec" href="/{{ page.version }}/staffDef">staffDef</a> (direct member of att.staffDef.vis)
               </div>
            </div>
         </td>
      </tr>
      <tr>
         ...
         <td class="wovenodd-col2">
            ...
            <div class="attributeDef">
               ...
               <span class="attributeClasses">
                  <a class="link_odd" href="/{{ page.version }}/att.staffDef.vis">att.staffDef.vis</a>
               </span>
            </div>
            <div class="attributeDef">
            ...
            <div class="attributeDef">
               ...
               Value conforms to 
               <a class="link_odd_classSpec" href="/{{ page.version }}/data.LAYERSCHEME">data.LAYERSCHEME</a>.
            ...
            <div class="attributeDef">
               ...
               <a class="link_odd_classSpec" href="/{{ page.version }}/data.COLOR">data.COLOR</a>, separated by spaces.
