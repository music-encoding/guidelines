         ...
         <td class="wovenodd-col2">
            <div class="parent">
               <div>
                  ...
                  <a class="link_odd_elementSpec" href="/{{ page.version }}/elements/symbol.html">symbol</a> (direct members of att.typography)
               </div>
               <div>
               ...
               <div>
                  ...
                  <span> (via 
                     <a class="link_odd_classSpec" href="/{{ page.version }}/attribute-classes/att.lyrics.vis.html">att.lyrics.vis</a>)
                  </span>
               </div>
               <div>
