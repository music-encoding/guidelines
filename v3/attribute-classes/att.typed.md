         ...
         <td class="wovenodd-col2">
            <div class="parent">
               <div>
                  ...
                  <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/zone.html">zone</a> (direct members of att.typed)
               </div>
            </div>
         </td>
      </tr>
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>When appropriate, values from an established typology should be used. Alternatively,
               ...
               <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/classification.html">classification</a> element. If values are to be taken from a project-specific list,
