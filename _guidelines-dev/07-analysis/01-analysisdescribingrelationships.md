...
{% include mei example="analysis/analysis-sample172.mei" valid="" %}
...
{% include mei example="analysis/analysis-sample173.mei" valid="" %}

This example can be reduced further by using **@copyof** inside the initial tuplet to represent the repeated chords:

{% include mei example="analysis/analysis-sample174.mei" valid="" %}
...
{% include mei example="analysis/analysis-sample175.mei" valid="" %}
...
{% include mei example="analysis/analysis-sample176.mei" valid="" %}
...
{% include mei example="analysis/analysis-sample177.mei" valid="" %}
...
{% include mei example="analysis/analysis-sample178.mei" valid="" %}
