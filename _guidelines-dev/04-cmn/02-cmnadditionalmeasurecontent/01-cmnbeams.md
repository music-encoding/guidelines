...
{:.gloss}
**acc**:  - The secondary beams start in their usual position and gradually converge until they
...
{:.gloss}
**beam.group**:  - Provides an example of how automated beaming (including secondary beams) is to be
          performed.

{:.gloss}
**beam.rests**:  - Indicates whether automatically-drawn beams should include rests shorter than a
