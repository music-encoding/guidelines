                  ...
                  <tr>
                     <td>
                        <div class="attributeDef">
                           ...
                           <span class="attributeClasses">
                              <a class="link_odd" href="{{ site.baseurl }}/{{ page.version }}/attribute-classes/trackConfig.html">trackConfig</a>
                           </span>
                        </div>
                     </td>
                  </tr>
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>The number of apparent playback channels can differ from the number of physical channels
               ...
               sound
               medium, while the 
               <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/soundChan.html">soundChan</a> element should be used to state that
