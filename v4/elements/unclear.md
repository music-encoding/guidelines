      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>Where the difficulty in transcription arises from an identifiable cause, the
               ...
               point to one or more identifiers declared in the document header.In no case should
               <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/unclear.html">unclear</a> contain elements that would not otherwise
