      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>This element will often be combined with a regularized form within a choice element.
               ...
               certainty ascribed to the transcription of the original text.In no case should <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/orig.html">orig</a> contain elements that would not otherwise be
