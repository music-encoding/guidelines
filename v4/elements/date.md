...
<div class="specPage">
   <div class="elementSpec">
      <h3 id="date">&lt;date&gt;</h3>
      <div class="specs">
         <div class="desc">A string identifying a point in time or the time period between two such points.
            <div class="chapterLinksBox"><a class="chapterLink desc" href="/guidelines/v4/content/shared.html#sharedNames">1.3.4.1 Names and Dates</a>,<a class="chapterLink desc" href="/guidelines/v4/content/shared.html#sharedBibliographicCitations">1.3.6 Bibliographic Citations and References</a>,<a class="chapterLink" href="/guidelines/v4/content/header.html#headerEditionstmt">2.1.2 Edition Statement</a>,<a class="chapterLink desc" href="/guidelines/v4/content/header.html#headerPublicationDistribution">2.1.4 Publication, Distribution, etc.</a>,<a class="chapterLink" href="/guidelines/v4/content/header.html#headerWorkHistory">2.3.5 Work History</a>,<a class="chapterLink" href="/guidelines/v4/content/header.html#headerRevisionDescription">2.5 Revision Description</a>,<a class="chapterLink" href="/guidelines/v4/content/namesdates.html#&#34;namesDates&#34;">17 Names and Dates</a>,<a class="chapterLink desc" href="/guidelines/v4/content/namesdates.html#namesdatesBasic">17.1 Basic Elements for Names and Dates</a>,<a class="chapterLink" href="/guidelines/v4/content/namesdates.html#namesdatesSpecialized">17.2 Specialized Name and Date Elements</a></div>
         </div>
         ...
         <div class="facet memberships">
            ...
            <div class="statement memberships">
               <div class="memberOf"><a class="link_odd_classSpec" href="{{ site.baseurl }}/{{ page.version }}/model-classes/model.datelike.html">model.dateLike</a><span class="groupDesc">Groups elements containing date expressions.</span></div>
            </div>
         </div>
            ...
            <div class="statement classes list">
               ...
               <div id="containedBy_tabbedContent_class" class="facetTabbedContent class">
                  <div class="classBox" title="model.dateLike">
                     ...
                     <div class="classContent">
                        <div class="elementDef def"><span class="ident element" title="Individual change within the revision description."><a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/change.html">change</a></span><span class="elementDesc desc">Groups elements containing date expressions.</span></div>
                        <div class="elementDef def"><span class="ident element" title="Contains historical information given as a sequence of significant past events."><a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/eventlist.html">eventList</a></span><span class="elementDesc desc">Groups elements containing date expressions.</span></div>
                        <div class="elementDef def"><span class="ident element" title="Describes a distinctive state in the textual development of a work."><a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/genstate.html">genState</a></span><span class="elementDesc desc">Groups elements containing date expressions.</span></div>
               ...
               <div id="containedBy_tabbedContent_module" class="facetTabbedContent module">
                  ...
                  <div class="classBox" title="MEI.genetic">
                     ...
                     <div class="classContent">
                        <div class="elementRef"><a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/genstate.html">genState</a><span class="elementDesc">Describes a distinctive state in the textual development of a work.</span></div>
                     </div>
                  </div>
                  ...
                  <div class="classBox" title="MEI.header">
                     ...
                     <div class="classContent">
                        <div class="elementRef"><a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/byline.html">byline</a><span class="elementDesc">Contains the primary statement of responsibility given for a work on its title
                              page.</span></div>
                        <div class="elementRef"><a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/change.html">change</a><span class="elementDesc">Individual change within the revision description.</span></div>
         ...
         <div class="facet declaration">
            ...
            <div class="statement declaration">
               <div class="code" xml:space="preserve" data-lang="ODD"><code>
                     <div class="indent1 indent"><span data-indentation="1" class="element">&lt;elementSpec <span class="attribute">ident=</span><span class="attributevalue">"date"</span> <span class="attribute">module=</span><span class="attributevalue">"MEI.shared"</span>&gt;</span>
                        
                        <div class="indent2 indent"><span data-indentation="2" class="element">&lt;desc&gt;</span>A string identifying a point in time or the time period between two such points.<span data-indentation="2" class="element">&lt;/desc&gt;</span></div>
                        ...
                        <div class="indent2 indent"><span data-indentation="2" class="element">&lt;classes&gt;</span>
                           ...
                           <div class="indent3 indent"><span data-indentation="3" class="element">&lt;memberOf
                                 <span class="attribute">key=<span class="attributevalue">"<a class="link_odd" href="{{ site.baseurl }}/{{ page.version }}/model-classes/model.datelike.html">model.dateLike</a>"</span></span>/&gt;</span></div>
