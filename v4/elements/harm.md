...
<div class="elementSpec">
   ...
   <table class="wovenodd">
         ...
         <td class="wovenodd-col2">
            <table class="table table-striped">
               ...
               <tbody>
                  <tr>
                     <td>
                        <div class="attributeDef"><span class="attribute"><strong>@chordref</strong></span><span class="attributeUsage">(optional)</span><span class="attributeDesc">Contains a reference to a <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/chordDef.html">chordDef</a> element elsewhere in the
                              document.</span>
                  ...
                  <tr>
                     <td>
                        <div class="attributeDef"><span class="attribute"><strong>@rendgrid</strong></span><span class="attributeUsage">(optional)</span><span class="attributeDesc">Describes how the harmonic indication should be rendered.</span>
                           Allowed values are:
                           "<span style="font-weight: 500;">grid</span>" <i>(Chord tablature grid.)</i>,  "<span style="font-weight: 500;">gridtext</span>" <i>(Chord tablature grid and the element's textual content.)</i>,  "<span style="font-weight: 500;">text</span>" <i>(Textual content of the element.)</i><span class="attributeClasses"><a class="link_odd" href="{{ site.baseurl }}/{{ page.version }}/attribute-classes/att.harm.vis.html">att.harm.vis</a></span></div>
                     </td>
                  </tr>
                  <tr>
                     <td>
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <div class="parent"><a class="link_odd_classSpec" href="{{ site.baseurl }}/{{ page.version }}/model-classes/model.harmLike.html">model.harmLike</a></div>
         </td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <div class="specChildren">
               ...
               <div class="specChild"><span class="specChildModule">MEI.harmony</span><span class="specChildElements"><a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/fb.html">fb</a></span></div>
