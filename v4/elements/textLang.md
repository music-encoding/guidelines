         ...
         <td class="wovenodd-col2">
            <table class="table table-striped">
               ...
               <tbody>
                  ...
                  <tr>
                     <td>
                        <div class="attributeDef"><span class="attribute"><strong>@lang.main</strong></span><span class="attributeUsage">(optional)</span><span class="attributeDesc">(main language) supplies a code which identifies the chief language used in the
                              bibliographic work.</span>
                           Value of datatype <span style="font-weight: 500;">language</span>.
                           <span class="attributeClasses"><a class="link_odd" href="{{ site.baseurl }}/{{ page.version }}/attribute-classes/textLang.html">textLang</a></span></div>
                     </td>
                  </tr>
                  <tr>
                     <td>
                        <div class="attributeDef"><span class="attribute"><strong>@lang.other</strong></span><span class="attributeUsage">(optional)</span><span class="attributeDesc">(other languages) one or more codes identifying any other languages used in the
                              bibliographic work.</span>
