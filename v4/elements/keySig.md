                  ...
                  <tr>
                     <td>
                        <div class="attributeDef">
                           ...
                           <span class="attributeClasses">
                              <a class="link_odd" href="{{ site.baseurl }}/{{ page.version }}/attribute-classes/att.keySig.log.html">att.keySig.log</a>
                           </span>
                        </div>
                     </td>
                  </tr>
                  ...
                  <tr>
                     <td>
                        <div class="attributeDef">
                           ...
                           <span class="attributeClasses">
                              <a class="link_odd" href="{{ site.baseurl }}/{{ page.version }}/attribute-classes/att.keySig.vis.html">att.keySig.vis</a>
                           </span>
                        </div>
                     </td>
                  </tr>
                  ...
                  <div class="indent1 indent">
                     ...
                     <div class="indent2 indent">
                        <span data-indentation="2" class="element">&lt;memberOf
                           ...
                           <span class="attribute">key=
                              <span class="attributevalue">"
                                 <a class="link_odd" href="{{ site.baseurl }}/{{ page.version }}/attribute-classes/att.keySig.anl.html">att.keySig.anl</a>"
                              </span>
                           </span>/&gt;
                        </span>
                     </div>
                     ...
                     <div class="indent2 indent">
                        <span data-indentation="2" class="element">&lt;memberOf
                           ...
                           <span class="attribute">key=
                              <span class="attributevalue">"
                                 <a class="link_odd" href="{{ site.baseurl }}/{{ page.version }}/attribute-classes/att.keySig.ges.html">att.keySig.ges</a>"
                              </span>
                           </span>/&gt;
                        </span>
                     </div>
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>This element may be used as an alternative to the key.* attributes (especially
               ...
               <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/scoreDef.html">scoreDef</a> and 
               <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/staffDef.html">staffDef</a>.
            </p>
         </td>
      </tr>
