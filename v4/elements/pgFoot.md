                  ...
                  <tr>
                     <td>
                        <div class="attributeDef">
                           ...
                           <span class="attributeClasses">
                              <a class="link_odd" href="{{ site.baseurl }}/{{ page.version }}/attribute-classes/pgFoot.html">pgFoot</a>
                           </span>
                        </div>
                     </td>
                  </tr>
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>This element is used to capture the textual data that often appears on the first page
               ...
               <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/pgFoot.html">pgFoot</a> within a previous 
