                  ...
                  <tr>
                     <td>
                        <div class="attributeDef">
                           ...
                           <span class="attributeClasses">
                              <a class="link_odd" href="{{ site.baseurl }}/{{ page.version }}/attribute-classes/pgHead.html">pgHead</a>
                           </span>
                        </div>
                     </td>
                  </tr>
                        ...
                        <div class="indent3 indent">
                           ...
                           <div class="indent4 indent">
                              <span data-indentation="4" class="element">&lt;rng:ref
                                 ...
                                 <span class="attribute">name=
                                    <span class="attributevalue">"
                                       <a class="link_odd" href="{{ site.baseurl }}/{{ page.version }}/elements/anchoredText.html">anchoredText</a>"
                                    </span>
                                 </span>
                                 /&gt;
                              </span>
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>This element is used to capture the textual data that often appears on the first page
               ...
               When
               used within 
               <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/pb.html">pb</a>, it records a temporary suspension of the pattern of
               page headers established by the use of 
               <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/pgHead.html">pgHead</a> within a previous 
               <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/scoreDef.html">scoreDef</a>. Auto-generated page numbers may be indicated with a
