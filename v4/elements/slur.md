      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>Historically, the term "slur" indicated two notes performed legato, while the term
               ...
               one starting and one ending type of attribute. Either <span class="att">place</span>, <span class="att">bulge</span>, or
               <span class="att">bezier</span> attributes may be used to record the curvature of the phrase/slur. The
               <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/slur.html">slur</a> and <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/tie.html">tie</a> elements may be used instead of
               the slur.* and tie.* attributes provided on <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/chord.html">chord</a> and <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/note.html">note</a> elements when 1) they are required by software, or 2) multiple, alternative
               slurs are needed.
            </p>
         </td>
      </tr>
