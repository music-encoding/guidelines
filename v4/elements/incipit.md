...
<div class="elementSpec">
   <h3 id="incipit">&lt;incipit&gt;</h3>
   <table class="wovenodd">
      <tr>
         <td colspan="2" class="wovenodd-col2">Contains the opening words of the text proper, exclusive of any rubric which might
            precede
            it, of sufficient length to identify the work uniquely.
         </td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>This element is modelled on an element in the Text Encoding Initiative (TEI) standard.Incipits
               were, in former times, frequently used as a means of reference to a work, in place
               of a title.
            </p>
         </td>
      </tr>
