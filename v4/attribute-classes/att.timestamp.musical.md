         ...
         <td class="wovenodd-col2">
            <div class="parent">
               ...
               <div>
                  ...
                  <span> (via 
                     <a class="link_odd_classSpec" href="{{ site.baseurl }}/{{ page.version }}/attribute-classes/att.barLine.ges.html">att.barLine.ges</a>)
                  </span>
               </div>
               <div>
                  <span>
                        ...
                        <span data-indentation="3" class="element">&lt;rng:ref
                           ...
                           <span class="attribute">name=
                              <span class="attributevalue">"
                                 <a class="link_odd" href="{{ site.baseurl }}/{{ page.version }}/data-types/data.BEAT.html">data.BEAT</a>"
                              </span>
                           </span>
                           /&gt;
                        </span>
