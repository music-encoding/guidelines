...
sidebar: s1
version: "v4"
title: "att.ligatureSpan.vis"

---

<div class="classSpec att">
   <h3 id="att.ligatureSpan.vis">att.ligatureSpan.vis</h3>
   <table class="wovenodd">
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <div class="parent">
               <div><a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/ligatureSpan.html">ligatureSpan</a> (direct member of att.ligatureSpan.vis)
               </div>
            </div>
         </td>
      </tr>
