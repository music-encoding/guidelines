...
<div class="classSpec att">
   ...
   <table class="wovenodd">
      <tr>
         <td colspan="2" class="wovenodd-col2">Visual domain attributes for slur. The vo attribute is the vertical offset (from its
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <div class="parent">
               <div><a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/slur.html">slur</a> (direct member of att.slur.vis)
               </div>
            </div>
         </td>
      </tr>
