...
<div class="classSpec model">
   <h3 id="model.qLike">model.qLike</h3>
   <table class="wovenodd">
      <tr>
         <td colspan="2" class="wovenodd-col2">Groups elements related to highlighting which can appear at the phrase-level.</td>
      </tr>
      <tr>
      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <div class="parent">
               <div><a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/q.html">q</a> (direct member of model.qLike)
               </div>
            </div>
         </td>
      </tr>
