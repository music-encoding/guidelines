...
{% include specDesc.html version=page.version key="lyrics" atts="" %}
{% include specDesc.html version=page.version key="lyrics" atts="att.staffident/staff.txt att.layerident/layer.txt" %}
