...
The [group](/v3/elements/group.html){:.link_odd_elementSpec} element may be used to represent a collection of
...
corpora, covered more fully in chapter <a class="link_ptr" title="Musical Corpora" href="/v3/guidelines/corpus.html">9 Musical Corpora</a>.
...
Examples of composite texts which may be represented using the [group](/v3/elements/group.html){:.link_odd_elementSpec} element include anthologies and other collections. The presence of common
...
The [group](/v3/elements/group.html){:.link_odd_elementSpec} element may be used to encode any kind of collection in
