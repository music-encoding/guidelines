         ...
         <div class="facet usedBy" id="usedBy">
            ...
            <div class="statement list">
               ...
               <div class="classBox dtBox" title="Attribute Classes">
                  ...
                  <div class="classContent"><span class="ident attclass" data-ident="att.soundLocation" data-module="MEI.gestural"><a class="classLink" title="Attributes that locate a sound source within 3-D space." href="{{ site.baseurl }}/{{ page.version }}/attribute-classes/att.soundlocation.html">att.soundLocation</a>/<span title="The lateral or left-to-right plane.">@azimuth</span></span><span class="ident attclass" data-ident="att.soundLocation" data-module="MEI.gestural"><a class="classLink" title="Attributes that locate a sound source within 3-D space." href="{{ site.baseurl }}/{{ page.version }}/attribute-classes/att.soundlocation.html">att.soundLocation</a>/<span title="The above-to-below axis.">@elevation</span></span><span class="ident attclass" data-ident="att.coordinated" data-module="MEI.shared"><a class="classLink" title="This attribute class records the position of a feature within a two-dimensional coordinate system." href="{{ site.baseurl }}/{{ page.version }}/attribute-classes/att.coordinated.html">att.coordinated</a>/<span title="Indicates the amount by which the contents of this element have been rotated clockwise or, if applicable, how the orientation of the element self should be interpreted, with respect to the normal orientation of the parent surface. The orientation is expressed in arc degrees.">@rotate</span></span></div>
               </div>
