...
sidebar: s1
version: "dev"
title: "att.STEMPROPERTIES.mensural"
---
<div class="specPage">
   <div class="attClassSpec">
      <h3 id="att.STEMPROPERTIES.mensural">att.STEMPROPERTIES.mensural</h3>
      <div class="specs">
         <div class="desc">Attributes that describe the properties of stems in the mensural repertoire.</div>
         ...
         <div class="facet attributes" id="attributes">
            ...
            <div class="statement classes list">
               ...
               <div id="attributes_tabbedContent_compact" class="facetTabbedContent compact active"><span class="ident attribute" title="Describes the direction of a stem.">dir</span>, <span class="ident attribute" title="Encodes the form of the flag using the values provided by the data.FLAGFORM.mensural datatype.">flag.form</span>, <span class="ident attribute" title="Records the position of the flag using the values provided by the data.FLAGPOS.mensural datatype.">flag.pos</span>, <span class="ident attribute" title="Encodes the form of the stem using the values provided by the data.STEMFORM.mensural datatype.">form</span>, <span class="ident attribute" title="Encodes the stem length.">length</span>, <span class="ident attribute" title="Records the position of the stem in relation to the note head(s).">pos</span>, <span class="ident attribute" title="Encodes an x coordinate for a feature in an output coordinate system. When it is necessary to record the placement of a feature in a facsimile image, use the facs attribute.">x</span>, <span class="ident attribute" title="Encodes a y coordinate for a feature in an output coordinate system. When it is necessary to record the placement of a feature in a facsimile image, use the facs attribute.">y</span></div>
         ...
         <div class="facet declaration">
            ...
            <div class="statement declaration">
               <div class="code" xml:space="preserve" data-lang="ODD"><code>
                     <div class="indent1 indent"><span data-indentation="1" class="element">&lt;classSpec <span class="attribute">ident=</span><span class="attributevalue">"att.STEMPROPERTIES.mensural"</span> <span class="attribute">module=</span><span class="attributevalue">"MEI.mensural"</span> <span class="attribute">type=</span><span class="attributevalue">"atts"</span>&gt;</span>
                        
                        <div class="indent2 indent"><span data-indentation="2" class="element">&lt;desc&gt;</span>Attributes that describe the properties of stems in the mensural repertoire.<span data-indentation="2" class="element">&lt;/desc&gt;</span></div>
                        ...
                        <div class="indent2 indent"><span data-indentation="2" class="element">&lt;attList&gt;</span>
                           ...
                           <div class="indent3 indent"><span data-indentation="3" class="element">&lt;attDef <span class="attribute">ident=</span><span class="attributevalue">"length"</span> <span class="attribute">usage=</span><span class="attributevalue">"opt"</span>&gt;</span>
