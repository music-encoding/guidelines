         ...
         <td class="wovenodd-col2">
            <table class="table table-striped">
               ...
               <tbody>
                  ...
                  <tr>
                     <td>
                        <div class="attributeDef"><span class="attribute"><strong>@form</strong></span><span class="attributeUsage">(required)</span><span class="attributeDesc">Indicates whether this is note-on or note-off velocity data.</span>
                           Allowed values are:
                           "<span style="font-weight: 500;">on</span>" <i>(Note-on velocity.)</i>,  "<span style="font-weight: 500;">off</span>" <i>(Note-off velocity.)</i><span class="attributeClasses"><a class="link_odd" href="{{ site.baseurl }}/{{ page.version }}/attribute-classes/vel.html">vel</a></span></div>
                     </td>
                  </tr>
                  <tr>
                     <td>
