                  ...
                  <tr>
                     <td>
                        <div class="attributeDef"><span class="attribute"><strong>@form</strong></span><span class="attributeUsage">(required)</span><span class="attributeDesc">Indicates whether this is note-on or note-off velocity data.</span>
                           Allowed values are:
                           "<span style="font-weight: 500;">on</span>" ,  "<span style="font-weight: 500;">off</span>" <span class="attributeClasses"><a class="link_odd" href="{{ site.baseurl }}/{{ page.version }}/attribute-classes/vel.html">vel</a></span></div>
                     </td>
                  </tr>
                  <tr>
                     <td>
