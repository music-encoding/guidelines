...
<div class="elementSpec">
   ...
   <table class="wovenodd">
      <tr>
         <td colspan="2" class="wovenodd-col2">(locus group) – Groups locations which together form a distinct but discontinuous
            item
                  ...
                  <tr>
                     <td>
                        <div class="attributeDef"><span class="attribute"><strong>@scheme</strong></span><span class="attributeUsage">(optional)</span><span class="attributeDesc">Identifies the foliation scheme in terms of which the location is being specified
                              ...
                              resource.</span>
                           Value conforms to <a class="link_odd_classSpec" href="{{ site.baseurl }}/{{ page.version }}/data-types/data.uri.html">data.URI</a>.
                           <span class="attributeClasses"><a class="link_odd" href="{{ site.baseurl }}/{{ page.version }}/attribute-classes/locusgrp.html">locusGrp</a></span></div>
                     </td>
                  </tr>
                  <tr>
                     <td>
