      ...
      <tr>
         ...
         <td class="wovenodd-col2">
            <p>The rhythmic meaning of the components of a ligature is typically contextual, not
               ...
               pair. The <a class="link_odd_elementSpec" href="{{ site.baseurl }}/{{ page.version }}/elements/ligature.html">ligature</a> element should <span class="hi">not</span> be used for
